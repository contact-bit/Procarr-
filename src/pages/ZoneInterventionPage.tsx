      ...
      <section className="zone-hero">
        ...
        <div className="container">
          <p className="zone-kicker">
            Procarré &amp; Fils – Carreleurs à Manosque (04)
          </p>
      ...
      <section className="zone-list">
        <div className="container">
          ...
          <ul className="zone-ul">
            ...
            <li>
              <strong>Reillanne</strong> – Travaux de carrelage pour cuisines, pièces de vie, escaliers,
      ...
      <section className="zone-text">
        <div className="container">
          ...
          <p>
            ...
            salle de bain, refaire les sols de votre maison ou lancer une rénovation plus globale,
          ...
          <div className="zone-faq">
            ...
            <p>
              Oui, ponctuellement dans le 83, 84 et 05 selon le projet.
            </p>

            <h3>Comment savoir si vous pouvez intervenir chez moi&nbsp;?</h3>
            <p>
              Envoyez-nous votre projet avec votre commune et quelques photos.
            </p>
          </div>

          <p className="zone-cta">
            <a href="/devis">Demandez un devis gratuit</a> ou{' '}
